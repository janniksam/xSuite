...
```
xsuite build-reproducible --image-tag <docker-image-tag>`
```

You can customize the reproducible build process further by specifying options such as the directory, target directory, various docker options and more.
