...
- `xsuite build-reproducible` - builds a reproducible contract
  - '--image-tag <IMAGE_TAG>' - specify the tag of the image, that is used to build the contract (e. g. v6.1.0)
