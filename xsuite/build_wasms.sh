...
pnpm xsuite build-reproducible --image multiversx/sdk-rust-contract-builder:v6.1.0 --dir $DEST_DIR -r --target-dir $TARGET_DIR --no-docker-tty --no-docker-interactive
